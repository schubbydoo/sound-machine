# MicroPython firmware for Sound Machine (Pico) - Robust version
# - 16 buttons active-low -> prints "P,<id>\n" on press
# - Handles interrupts gracefully to prevent dropping into REPL
...
print("Sound Machine Pico firmware starting (robust version)...")
...
while True:
    try:
        ...
        time.sleep_ms(100)  # Brief pause on error
        continue
